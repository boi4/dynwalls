...
Available actions:
   {}
    ...
    def setcmd(self):
        self.subparser.add_argument("cmdstring", help="The command to use for updating the wallpaper. If it contains one or multiple '{}' strings, they will be replaced with the filename, otherwise the filename is put after the command.")
